...
export default function Home() {
  ...
  useEffect(() => {
    heroSlides.forEach(({ image_url }) => {
      if (image_url) { const i = new Image(); i.src = image_url }
    })
  }, [heroSlides])
      ...
      <section className="py-14 bg-white">
        <div className="max-w-7xl mx-auto px-4 grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative">
            <img
              src={aboutImageUrl || 'https://upload.wikimedia.org/wikipedia/commons/thumb/9/9e/The_castle_above_Taiz_%288683935588%29.jpg/1280px-The_castle_above_Taiz_%288683935588%29.jpg'}
