          ...
          <>
            ...
            {activeTab==='identity' && (
              <div className="space-y-4">
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">{isRtl?'شعار الموقع (Logo)':'Site Logo'}</label>
                  <ImageUpload value={form.logo_url||''} onChange={v=>setForm({...form,logo_url:v})} folder="site" label={isRtl?'رفع الشعار':'Upload Logo'}/>
                </div>
            ...
            {activeTab==='about' && (
              <div className="space-y-4">
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">{isRtl?'صورة قسم من نحن':'About Section Image'}</label>
                  <ImageUpload value={form.home_about_image_url||''} onChange={v=>setForm({...form,home_about_image_url:v})} folder="site" label={t.image}/>
                </div>
                <div className="grid grid-cols-2 gap-4">
